var app = angular.module('madStdSeventhPage', []);
(function (app) {
    "use strict";
    app.controller('myCtrl', function ($scope, $http) {
        ...
        $http({
            method: 'GET',
            url: 'http://127.0.0.1:8000/madStdSeventhPage/' + inst_id
        ...
        $scope.submitData = function () {
            ...
            $http({
                method: 'POST',
                url: 'http://127.0.0.1:8000/madStdSeventhPage/submitData/',
                data: dataToSend,
                dataType: 'json'
            }).then(
                function (response) {
                    console.log(response);
                    alert("Seventh page data has been saved succesfull");
                },
                function (response) {
                    console.log(response);
                    alert("Try again");
