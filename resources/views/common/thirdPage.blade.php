                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col">শিক্ষক <input type="checkbox" v-model="data.institutes_ict_infos.padago_internet_tea"/></div>
                                <div class="col">শিক্ষক ও শিক্ষার্থী <input type="checkbox" v-model="data.institutes_ict_infos.padago_internet_std_tea"/></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td><input class="mr-2" type="checkbox" v-model="data.institutes_facilities_others.tubewl">নলকূপ
                                    </td>
                                    <td><input class="mr-2" type="checkbox" v-model="data.institutes_facilities_others.deep_tubewel">গভীর
                                        নলকূপ
                                    </td>
                                </tr>
                                <tr>
                                    <td><input class="mr-2" type="checkbox"v-model="data.institutes_facilities_others.supply_water">সাপ্লাই পানি
                                    </td>
                                    <td><input class="mr-2" type="checkbox" v-model="data.institutes_facilities_others.jhorna">ঝর্ণা
                                    </td>
                                    <td><input class="mr-2" type="checkbox" v-model="data.institutes_facilities_others.bottle_water">বোতল জাত পানি/পানির
                                        জার
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3"><input class="mr-2" type="checkbox" v-model="data.institutes_facilities_others.rain_water">বৃষ্টির পানি
                                        হার্ভেস্টিং
                                    </td>
                                </tr>
                            </table>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <table class="table table-bordered">
                            <tr>
                                <td><input type="checkbox" v-model="data.institutes_libraries.language_bangla"/> বাংলা</td>
                                <td><input type="checkbox" v-model="data.institutes_libraries.language_english"/> ইংরেজি</td>
                                <td><input type="checkbox" v-model="data.institutes_libraries.language_arabic"/> আরবি</td>
                              <tr/>
                                <tr>
                                    <td><input type="checkbox" v-model="data.institutes_libraries.language_chinese"/> চাইনিজ</td>
                                    <td><input type="checkbox" v-model="data.institutes_libraries.language_korean"/> কোরিয়ান</td>
                                    <td><input type="checkbox" v-model="data.institutes_libraries.language_japan"/> জাপানি</td>
                                </tr>
                                <tr>
                                    <td><input type="checkbox" v-model="data.institutes_libraries.language_russian"/> রুশ</td>
                                    <td><input type="checkbox" v-model="data.institutes_libraries.language_spanish"/> স্প্যানিশ</td>
                                    <td><input type="checkbox" v-model="data.institutes_libraries.language_others"/> অন্যান্য</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
