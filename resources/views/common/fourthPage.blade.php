    ...
    <div class="container" id="fourthPage">
        ...
        <div class="contentBox">
            ...
            <div class="contentBoxBody">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <td>
                            <label>৩.৯.১৩ ক্ষুদ্র নৃ-গোষ্ঠী শিক্ষার্থীদের জন্য দ্বিভাষিক শিক্ষা ও শিখন কার্যক্রম চালু
                                আছে কি?</label>
                    ...
                    <tr>
                        <td>
                            <label>৩.৯.২২ প্রতিষ্ঠানটিতে নিরাপদ সড়ক বিষয়ে সচেতনতামূলক কার্যক্রম পরিচালিত হয় কি? </label>
                        ...
                        <td>
                            <label>৩.৯.২৩ প্রতিষ্ঠানটিতে জাতীয় শুদ্ধাচার কৌশল বিষয়ে কোন কার্যক্রম পরিচালিত হয় কি?</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>৩.৯.৩১ উত্তর হ্যাঁ হলে, নির্দিষ্ট ঘরে টিক চিহ্ণ দিন।</label><br>
            ...
            <div class="contentBoxBody">
                <table class="table table-bordered table-striped">
                    <tr>
                        ...
                        <td><label> ৩.১০.৩ উত্তর হ্যাঁ হলে, সর্বশেষ কোন সালে ডিআইএ কর্তৃক অডিট সম্পন্ন হয়েছে </label>
                    ...
                    <tr>
                        ...
                        <td><label>৩.১০.৬ অর্থের পরিমাণ</label>
        ...
        <div class="contentBox">
            ...
            <div class="contentBoxBody">
                ...
                <table class="table table-bordered table-striped">
                    <tr>
                        <td>৩.১১.২ প্রতিষ্ঠানের সহায়তামূলক ও কমিউনিটি সার্ভিস পরিচালনার জন্য কোন পৃথক ব্যাংক হিসাব আছে কি?
