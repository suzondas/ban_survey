                        ...
                        <div class="col-md-8">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr class="custom-table-header">
                                    ...
                                    <th style="text-align:center">সর্বশেষ স্বীকৃতি/ অনুমতি মেয়াদ শেষ হওয়ার তারিখ</th>
                                </tr>
                                </thead>
                                <tbody>
                        ...
                        <tr>
                            ...
                            <td><label>১.৬.১ কমিটি থাকলে: </label>
                                <table class="table table-bordered" style="text-align:center">
                                    ...
                                    <tr>
                                        <td>
                                            <datepicker type="text" v-model="data.committees[0].approve_date"></datepicker>
                                        </td>
                                        <td>
                                            <datepicker type="text" v-model="data.committees[0].expire_date"></datepicker>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <td><label>১.৬.৩ কমিটি না থাকলে বিগত কমিটির মেয়াদ শেষ হওয়ার তারিখ</label>
                                <datepicker type="text" v-model="data.committees[0].last_commitee_expire_date"></datepicker>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <div class="row">
                                    ...
                                    <div><input type="text" class="w-25" v-model="data.committees[0].last_yr_meeting">
                                        টি
                                    </div>
                                </div>
                            ...
                            <td colspan="2">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <input class="mr-2" type="checkbox"
                                                   v-model="data.committees[0].mc_std_transport">শিক্ষার্থীদের যাতায়াতে
                                            নিরাপত্তা
                                        </td>
                                        <td>
                                            <input class="mr-2" type="checkbox"
                                    ...
                                    <tr>
                                        <td>
                                            <input class="mr-2" type="checkbox" v-model="data.committees[0].mc_dropout">ঝড়ে
                                            পড়া রোধ
                                        </td>
                                        <td>
                                            <input class="mr-2" type="checkbox"
