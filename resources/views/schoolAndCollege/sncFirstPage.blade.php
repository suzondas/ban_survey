...
@section('content')
    <div class="container">
        ...
        <div class="row mt-4 col-9">
            ২.১ স্তরভিত্তিক শিক্ষার্থী সংখ্যা ২০২১
        </div>
        ...
        <div class="row mt-2">
            ২.১.১ মাধ্যমিক স্তরে শ্রেণি, বিভাগভিত্তিক শিক্ষার্থী, ট্রান্সফার আউট, পুস্তকের চাহিদা অনুযায়ী শিক্ষার্থীর সংখ্যা ২০২১
        </div>
        ...
        <div class="row mt-4 col-9">
            ২.১.২ ২০২০ ও তার পূর্বের শিক্ষার্থী ২০২১ সালে একই শ্রেণিতে অধ্যয়নরত আছে এইরুপ শিক্ষার্থীর সংখ্যা (রিপিটার)
        </div>
        ...
        <div class="row mt-4 col-9">
            ২.১.৩ ২০২০ সালের ঝরেপড়া (ড্রপআউট) শিক্ষার্থীর সংখ্যা
        </div>
        <div class="row border border-info py-1 mt-2 col-12">
            <div class="col">
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.১.৪ সেকশনভিত্তিক শিক্ষার্থীর তথ্য ২০২১ (সেকশন না থাকলে পূরণ করা প্রযোজ্য নয়)
        </div>
        ...
        <div class="row border border-info py-1 ">
            <div class="col">
                ২.১.৫ উচ্চ মাধ্যমিক ও তদুর্ধ্ব স্তরে শ্রেণি ও বিভাগভিত্তিক শিক্ষার্থীর সংখ্যা ২০২১
                <table class="table table-bordered  " style="text-align:center">
                    <tr>
        ...
        <div class="row mt-4 col-9">
            ২.১.৬ এসএসসি ভোকেশনাল এর শ্রেণিভিত্তিক শিক্ষার্থী তথ্য ২০২১
        </div>
        <div class="row border border-info py-1 col-12">
            <div class="col">
                <table class="table table-bordered  " style="text-align:center">
                    <tr>
                        <td  rowspan="2" >শ্রেণি</td>
        ...
        <div class="row mt-4 col-9">
            ২.১.৭ এইচএসসি ভোকেশনাল এর বর্ষভিত্তিক শিক্ষার্থী তথ্য ২০২১
        </div>
        <div class="row border border-info py-1 col-12">
            <div class="col">
                <table class="table table-bordered  " style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.১.৮ এইচএসসি বিএম এর বর্ষভিত্তিক শিক্ষার্থী তথ্য ২০২১
        </div>
        <div class="row border border-info py-1 col-12">
            <div class="col">
                <table class="table table-bordered  " style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.১.৯ মাধ্যমিক স্তরে বিভিন্ন ক্যাটাগরিভিত্তিক শিক্ষার্থীর তথ্য ২০২১
        </div>
        <div class="row border border-info py-1 mt-2 col-12">
            <div class="col">
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.২ উচ্চ মাধ্যমিক ও তদুর্ধ্ব স্তরে বিভিন্ন ক্যাটাগরিভিত্তিক শিক্ষার্থীর তথ্য ২০২১
        </div>
        <div class="row border border-info py-1 mt-2 col-12">
            <div class="col">
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.২.৪ মাধ্যমিক স্তরে বিশেষ চাহিদাসম্পন্ন শিক্ষক ও শিক্ষার্থীর সংখ্যা ২০২১
        </div>
        <div class="row border border-info py-1 mt-2 col-12">
            <div class="col">
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.২.৫ উচ্চ মাধ্যমিক ও তদুর্ধ্ব স্তরে বিশেষ চাহিদাসম্পন্ন শিক্ষক ও শিক্ষার্থীর সংখ্যা ২০২১
        </div>
        <div class="row  py-1 mt-2 ">
            <div>
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.২.৬ মাধ্যমিক স্তরে ক্ষুদ্র নৃ-গোষ্ঠীর ধরন অনুযায়ী শিক্ষক ও শিক্ষার্থীর সংখ্যা ২০২১
        </div>
        <div class="row border border-info py-1 mt-2 col-12">
            <div class="col">
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.২.৭ উচ্চ মাধ্যমিক ও তদুর্ধ্ব স্তরে ক্ষুদ্র নৃ-গোষ্ঠীর ধরন অনুযায়ী শিক্ষক ও শিক্ষার্থীর সংখ্যা ২০২১
        </div>
        <div class="row border border-info py-1 mt-2 col-12">
            <div >
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.৩ মাধ্যমিক স্তরে বয়সভিত্তিক শিক্ষার্থীর সংখ্যা (০১/০১/২০২১ তারিখে বয়স)
        </div>
        ...
        <div class="row mt-4 col-9">
            ২.৩.১ উচ্চ মাধ্যমিক ও তদুর্ধ্ব স্তরে বয়সভিত্তিক শিক্ষার্থীর সংখ্যা (০১/০১/২০২১তারিখে বয়স)
        </div>
        <div class="row border border-info py-1">
            <div>
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.৩.২ অভিভাবকের পেশা অনুযায়ী মাধ্যমিক স্তরে শিক্ষার্থী সংখ্যা (৬ষ্ঠ-১০ম):
        </div>
        ...
        <div class="row mt-4 col-9">
            ২.৩.৩ অভিভাবকের পেশা অনুযায়ী উচ্চ মাধ্যমিক ও তদুর্ধ্ব স্তরে শিক্ষার্থীর সংখ্যা:
        </div>
        <div class="row border border-info py-1 mt-2 col-8">
            <div>
                <table class="table table-bordered" style="text-align:center">
        ...
        <div class="row mt-4 col-9">
            ২.৩.৪ মাধ্যমিক স্তরে শ্রেণি, বিভাগভিত্তিক শিক্ষার্থী, উত্তীর্ণ ও অনুত্তীর্ণ সম্পর্কিত তথ্য, ডিসেম্বর ২০২০ (বার্ষিক পরীক্ষার ফলাফল)
        </div>
        <div class="row border border-info py-1 mt-2 col-10">
            <div>
                <table class="table table-bordered" style="text-align:center">
