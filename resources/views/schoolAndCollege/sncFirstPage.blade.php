    ...
    <div class="contentBox">
        ...
        <div class="contentBox">
            ...
            <div class="contentBoxBody">
                ...
                <tbody>
                <tr>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].six_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].six_female"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].seven_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].seven_female"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].eight_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].eight_female"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].nine_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].nine_female"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].ten_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_repeater[0].ten_female"></td>
                </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="contentBox">
            ...
            <div class="contentBoxBody">
                ...
                <tbody>
                <tr>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].six_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].six_female"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].seven_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].seven_female"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].eight_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].eight_female"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].nine_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].nine_female"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].ten_total"></td>
                    <td><input type="text" class="form-control" v-model="data.Student_summary_dropout[0].ten_female"></td>
                </tr>
                </tbody>
            </table>
        </div>
                ...
                <table class="table table-bordered table-striped">
                    <tr>
                        ...
                        <td>২.২.১ প্রতিষ্ঠানে বিশেষ চাহিদাসম্পন্ন শিক্ষার্থী আছে কি?<br>
                            ...
                            <input type="checkbox" v-model="data.Institutes_special_student[0].disable_facility_others"> &nbsp;অন্যান্য-৪ </td>
