        ...
        <div class="contentBox">
            ...
            <div class="contentBoxBody">
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                    <tr>
                        <td><input type="number" number-converter class="form-control" ng-model="data.studentSummaryTotal.tec_ssc_total" ></td>
                        <td><input type="number" number-converter class="form-control" ng-model="data.studentSummaryTotal.tec_ssc_girl"></td>
                        <td><input type="number" number-converter class="form-control" ng-model="data.studentSummaryTotal.tec_hsc_total"></td>
                        <td><input type="number" number-converter class="form-control" ng-model="data.studentSummaryTotal.tec_hsc_girl"></td>
                        <td><input type="number" number-converter class="form-control" ng-model="data.studentSummaryTotal.dip_total"></td>
                        <td><input type="number" number-converter class="form-control" ng-model="data.studentSummaryTotal.dip_girl"></td>
                        <td><input type="number" number-converter class="form-control" ng-model="data.studentSummaryTotal.certf_total"></td>
                        <td><input type="number" number-converter class="form-control" ng-model="data.studentSummaryTotal.certf_girl"></td>
                    </tr>
                    </tbody>
                </table>
            </div>
