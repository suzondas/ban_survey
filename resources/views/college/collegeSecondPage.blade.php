            ...
            <div class="contentBoxBody">
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tr>
                        ...
                        <td><input class="w-50" type="number" ng-init="idx = findIndex(i.group_id,item.class_id)" ng-model="studentSummeryPrevYr[idx].total_student"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="studentSummeryPrevYr[idx].female_student"  /></td>
                        <td><input type="number" class="w-50" type="text" ng-model="studentSummeryPrevYr[idx].total_candidate"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="studentSummeryPrevYr[idx].female_candidate"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="studentSummeryPrevYr[idx].total_promoted"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="studentSummeryPrevYr[idx].female_promoted"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="studentSummeryPrevYr[idx].total_failed"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="studentSummeryPrevYr[idx].female_failed"/></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="contentBoxBody">
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tr ng-repeat="i in item.exam">
                        <td>@{{i.name}}</td>
                        <td><input type="number" class="w-50" type="text" ng-init="idx = findIndexEx(i.exam_id,i.subject)" ng-model="boardWiseExamResults[idx].registered_total"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].registerd_female"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].total_candidate"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].female_candidate"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].a_plus_total"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].a_total"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].a_minus_total"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].b_total"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].c_total"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].d_total"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].a_plus_girls"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].a_girls"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].a_minus_girls"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].b_girls"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].c_girls"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].d_girls"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].total_pass"/></td>
                        <td><input type="number" class="w-50" type="text" ng-model="boardWiseExamResults[idx].girls_pass"/></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-md-10">
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tr ng-repeat="item in data.openUnStd">
                        ...
                        <td><input type="number" class="w-50" ng-model="item.masters"></td>
                        <td><input type="number" class="w-50" ng-model="item.masters_female"></td>
                        <td><input type="number" class="w-50" ng-model="item.others"></td>
                        <td><input type="number" class="w-50" ng-model="item.others_female"></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            <div class="col">
                ...
                <table class="table table-bordered" style="text-align:center">
                    ...
                    <tr>
                        ...
                        <td>মোট</td>
                        <td><input type="number" class="w-50" string-to-number ng-model="item.eleven_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.eleven_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.twelve_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.twelve_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.honours_p_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.honours_p_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.honours_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.honours_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.masters_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.masters_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.others_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.others_pass"></td>
                    </tr>
                    <tr>
                        <td>ছাত্রী</td>
                        <td><input type="number" class="w-50" ng-model="item.eleven_fem_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.eleven_fem_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.twelve_fem_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.twelve_fem_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.honours_p_fem_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.honours_p_fem_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.honours_fem_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.honours_fem_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.masters_fem_std"></td>
                        <td><input type="number" class="w-50" ng-model="item.masters_fem_pass"></td>
                        <td><input type="number" class="w-50" ng-model="item.others_female"></td>
                        <td><input type="number" class="w-50" ng-model="item.others_fem_pass"></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-md-9"> ২.৪ মূল প্রতিষ্ঠানের পদবিভিত্তিক কর্মরত ও এমপিওভুক্ত (প্রযোজ্য ক্ষেত্রে) শিক্ষক ও
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tr ng-repeat="item in data.teachStafSum">
                        ...
                        <td><input type="number" class="w-50" ng-model="item.teachers_in_service"/></td>
                        <td><input type="number" class="w-50" ng-model="item.female_teachers_in_service"/></td>
                        <td><input type="number" class="w-50" ng-model="item.mpo_teachers"/></td>
                        <td><input type="number" class="w-50" ng-model="item.female_mpo_teachers"/></td>
                        <td><input type="number" class="w-50" ng-model="item.blank_post_no"/></td>
                        <td><input type="number" class="w-50" ng-model="item.ntrc_teacher"/></td>
                        <td><input type="number" class="w-50" ng-model="item.parttime_teacher"/></td>
                        <td><input type="number" class="w-50" ng-model="item.ntrc_blank_post"/></td>
                    </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <tr>
                        <td>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td class="text-center"> মোট: <input type="number" class="w-25" ng-model="data.teacherTrainInfo.creative_3day_total"/></td>
                                    <td class="text-center"> মহিলা: <input type="number" class="w-25" ng-model="data.teacherTrainInfo.creative_3day_female"/></td>
                                    <td class="text-center"> মোট: <input type="number" class="w-25" ng-model="data.teacherTrainInfo.creative_12day_total"/></td>
                                    <td class="text-center"> মহিলা: <input type="number" class="w-25" ng-model="data.teacherTrainInfo.creative_12day_female"/></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <table class="table table-bordered table-striped">
                    <tr>
                        <td><label>২.৪.৭ বিশেষ চাহিদাসম্পন্ন শিক্ষক এর কর্মকালীন প্রশিক্ষণের তথ্য (সংখ্যা লিখুন)</label><br>
                            মোট: <input type="number" class="w-25" ng-model="data.teacherTrainInfo.onjob_training_total"/>
                            মহিলা: <input type="number" class="w-25" ng-model="data.teacherTrainInfo.onjob_training_female"/></td>
                        <td><label>২.৪.৮ ক্ষুদ্র-নৃ-গোষ্ঠী শিক্ষক এর কর্মকালীন প্রশিক্ষণের তথ্য (সংখ্যা
                                লিখুন)</label><br>
                            মোট: <input type="number" class="w-25" ng-model="data.teacherTrainInfo.onjob_training_tribe_total"/>
                            মহিলা: <input type="number" class="w-25" ng-model="data.teacherTrainInfo.onjob_training_tribe_female"/></td>
                    ...
                    <tr>
                        ...
                        <td><label>২.৪.১১ উত্তর হ্যাঁ হলে কয়জন?</label><br>
                            <input type="number" class="w-25" ng-model="data.teacherTrainInfo.disaster_train_teacher"/>
                    </tr>
                </table>
                <table>
                    <tr>
            ...
            <div class="contentBoxBody">
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.cpd2_total"></td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.cpd2_female"></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.cluster_total"></td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.cluster_female"></td>
                    </tr>
                    <tr>
                        <td rowspan="2"></td>
                        <td colspan="2">প্রশিক্ষণপ্রাপ্ত শিক্ষক সংখ্যা</td>
                        <td>এস.বি. এ ট্রেনিং</td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.sba_total"></td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.sba_female"></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.srizonsil_total"></td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.srizonsil_female"></td>
                    </tr>
                    <tr>
                        <td>এসটিসি ট্রেনিং (৩ মাস)</td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.stc_training_total"></td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.stc_training_female"></td>
                        <td>অন্যান্য ট্রেনিং</td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.other_total"></td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.other_female"></td>
                    </tr>
                    <tr>
                        <td>এসটিটি থেকে বি.এড (৯ মাস)</td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.stt_bed_total"></td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.stt_bed_female"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.cpd1_total"></td>
                        <td><input type="number" class="w-50" ng-model="data.teacherInservTr.cpd1_female"></td>
                    </tr>
                    </tbody>
                </table>
            </div>
                ...
                <div class="col">
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.total_eng_teachers"></td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.female_eng_teacher"></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                <div class="col">২.৪.১৫ ইংরেজি বিষয়ে পাঠদানকারী শিক্ষকের স্নাতক (পাস), স্নাতক (সম্মান) ও স্নাতকোত্তর
                    ...
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.hons_100_eng"></td>
                        </tr>
                        <tr>
                            <td>২</td>
                            <td style="width: 350px">স্নাতক (পাস) পর্যায়ে ৩০০ নম্বরের ইংরেজি ছিল</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.hons_300_eng"></td>
                        </tr>
                        <tr>
                            <td>৩</td>
                            <td style="width: 350px">ইংরেজিতে স্নাতক সম্মান</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.eng_hons"></td>
                        </tr>
                        <tr>
                            <td>৪</td>
                            <td style="width: 350px">ইংরেজিতে স্নাতকোত্তর</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.eng_hons_mst"></td>
                        </tr>
                        <tr>
                            <td>৫</td>
                            <td style="width: 350px">স্নাতক (পাস) পর্যায়ে ইংরেজি ছিলা না</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.hons_without_eng"></td>
                        </tr>
                        <tr>
                            <td>৬</td>
                            <td style="width: 350px">এইচ এস সি পাস</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.eng_hsc_pass"></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="col">
                    <table class="table table-bordered  table-striped text-center">
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.total_math_teachers"></td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.female_math_teacher"></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                <div class="col">২.৪.১৭ গণিত বিষয়ে পাঠদানকারী শিক্ষকের স্নাতক (পাস), স্নাতক (সম্মান) ও স্নাতকোত্তর
                    ...
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.hons_pcm"></td>
                        </tr>
                        <tr>
                            <td>২</td>
                            <td style="width: 350px">স্নাতক (পাস) পর্যায়ে অন্যান্য বিষয়সহ গণিত ছিল</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.hons_other_math"></td>
                        </tr>
                        <tr>
                            <td>৩</td>
                            <td style="width: 350px">গণিতে স্নাতক সম্মান</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.math_hons"></td>
                        </tr>
                        <tr>
                            <td>৪</td>
                            <td style="width: 350px">গণিতে স্নাতকোত্তর</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.math_hons_mst"></td>
                        </tr>
                        <tr>
                            <td>৫</td>
                            <td style="width: 350px">স্নাতক (পাস) পর্যায়ে গণিত ছিল না কিন্তু এইচএসসিতে ছিল</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.deg_hsc_with_math"></td>
                        </tr>
                        <tr>
                            <td>৬</td>
                            <td style="width: 350px">স্নাতক বা এইচ এস সি পর্যায়ে ছিল না</td>
                            <td><input type="number" class="w-50" ng-model="data.teacherTrainInfo.hons_without_math"></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="contentBoxBody">
                <table class="table table-bordered table-striped ">
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.count_day_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.count_day_female" id=""></td>
                    </tr>
                    <tr>
                        <td>২</td>
                        <td style="width: 300px">অবসরে গিয়েছেন (১/৭/২০২০থেকে ৩০/৬/২০২১ পর্যন্ত)</td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.retired_teacher_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.rerired_teacher_female" id=""></td>
                    </tr>
                    <tr>
                        <td>৩</td>
                        <td style="width: 300px">অবসরে যাবেন (১/৭/২০২১ থেকে ৩০/৬/২০২২ পর্যন্ত)</td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.retiredfu_teacher_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.reriredfu_teacher_female" id=""></td>
                    </tr>
                    <tr>
                        <td>৪</td>
                        <td style="width: 300px">নতুন নিয়োগপ্রাপ্ত (১/৭/২০২০ থেকে ৩০/৬/২০২১ পর্যন্ত)</td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.new_recruite_teacher_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.new_recruite_teacher_female" id=""></td>
                    </tr>
                    <tr>
                        <td>৫</td>
                        <td style="width: 300px">শিক্ষকতা পেশা ছেড়ে দিয়েছেন (১/৭/২০২০ থেকে ৩০/৬/২০২১ পর্যন্ত)</td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.leave_teacher_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.leave_teacher_female" id=""></td>
                    </tr>
                    <tr>
                        <td>৬</td>
                        <td style="width: 300px">NTRCA কর্তৃক সুপারিশকৃত শিক্ষকের সংখ্যা</td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.ntrc_teacher_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.ntrc_teacher_female" id=""></td>
                    </tr>
                    <tr>
                        <td>৭</td>
                        <td style="width: 300px">বর্তমানে কতজন শিক্ষক গবেষণা কাজে সম্পৃক্ত</td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.research_teacher_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.research_teacher_female" id=""></td>
                    </tr>
                    <tr>
                        <td>৮</td>
                        <td style="width: 300px">একাডেমিক বিষয়ের ওপর পুরষ্কারপ্রাপ্ত শিক্ষকের সংখ্যা</td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.awarded_teacher_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.awarded_teacher_female" id=""></td>
                    </tr>
                    <tr>
                        <td>৯</td>
                        <td style="width: 300px">শিখন-শেখানো বিষয়ে প্রশিক্ষণপ্রাপ্ত (১/৭/২০২০ থেকে ৩০/৬/২০২১ পর্যন্ত)
                        </td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.learning_trained_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.learning_trained_female" id=""></td>
                    </tr>
                    <tr>
                        <td>১০</td>
                        ...
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.special_trained_total" id=""></td>
                        <td><input type="number" class="form-control w-25"ng-model="data.teacherRetAwInfo.special_trained_female" id=""></td>
                    </tr>
                    <tr>
                        <td>১১</td>
                        ...
                        <td><input type="number" class="form-control w-25" ng-model="data.teacherRetAwInfo.inclusive_total" id=""></td>
                        <td><input type="number" class="form-control w-25" ng-model="data.teacherRetAwInfo.inclusive_female" id=""></td>
                    </tr>
                    </tbody>
                </table>
            </div>
