        ...
        <div v-if="dataLoaded">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" v-model="data.institutes.teiin" readonly disabled>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select class="" name="english_ver_yn" v-model="data.institutes.lowest_class_id">
                                    ...
                                    <option value="9706">STANDARD-6</option>
                                </select>
                            </td>
                        </tr>
                    </table>
                        ...
                        <table class="table table-bordered table-striped">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select class="custom-select" v-model="data.institutes.campus_yn" style="width:120px">
                                        <option value="">Select</option>
                ...
                <div class="contentBox">
                    ...
                    <div class="contentBoxBody">
                        <table class="table table-bordered">
                            <tr>
                                <td>
                                    <label>১.৪.১ কমিটির আছে কি?</label>
                                    <select class="custom-select" v-model="data.committees.commitee_status" style="width:120px">
                                        <option value="">Select</option>
                                        <option value="1">হ্যাঁ</option>
                                        <option value="2">না</option>
                                    </select>
