...
@section('content')
    ...
    <div class="container-fluid" data-ng-app="privateTeachSecondPage" ng-controller="myCtrl">
            ...
            <div class="contentBoxBody">
                ...
                <table class="table table-sm table-bordered table-striped text-center">
                    <tr>
                        ...
                        <td colspan="2">খণ্ডকালীন/চুক্তিভিত্তিক শিক্ষক সংখ্যা</td>
                        <td colspan="2">মোট</td>
                    </tr>
        ...
        <div class="contentBox">
            <div class="input-group contentdeader">
                ...
                <div class="form-control bg-number-label"> ডিগ্রিভিত্তিক শিক্ষক সংখ্যা
                </div>
            </div>
            <div class="contentBoxBody">
                <div class="row">
                <div class="col-md-6">
                <label class="font-weight-bold">৪.৪.১ ডিগ্রিভিত্তিক নিয়মিত ও খণ্ডকালীন শিক্ষক সংখ্যা </label>
                <table class="table table-sm table-bordered table-striped text-center">
                    <tr>
                        {{--<td>স্তর</td>--}}
                        <td rowspan="2">ডিগ্রি</td>
                        <td colspan="2">পূর্ণকালীন শিক্ষক সংখ্যা</td>
