...
@section('content')
    ...
    <div class="container-fluid" data-ng-app="privateBibid" ng-controller="myCtrl">
                        ...
                        <div class="col-md-7">
                            ...
                            <table class="table table-sm table-bordered table-striped text-center">
                                <tr>
                                    {{--<td>স্তর</td>--}}
                                    <td>ক্রমিক</td>
                                    <td>বিভাগ/অনুষদ/স্কুল/ইনস্টিটিউট/একাডেমি</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">নিজ অর্থায়নে পরিচালিত গবেষণা প্রকল্প</td>
