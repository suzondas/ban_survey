...
@section('content')
    <div class="container" id="adminBanbeis">
        <div v-if="!dataLoaded">
        ...
        <div v-if="dataLoaded" class="shadow p-3 mb-5 bg-white rounded p-2 table-responsive mt-4">
            <h3 class=" text-center font-weight-bold text-secondary"><u>Welcome BANBEIS</u></h3>
            <h6 class=" text-center font-weight-bold text-primary "></h6>
