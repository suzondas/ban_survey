...
@section('content')
    <div class="container" id="teacherStaffInfo">
        ...
        <div v-if="dataLoaded" class="shadow p-3 mb-5 bg-white rounded p-2 table-responsive mt-4">
            <h3 class="m-1 text-center font-weight-bold text-secondary"><u>Ap Panel</u></h3>
            <h6 class=" text-center font-weight-bold text-primary ">Dighalia</h6>
<div class=" row col-12 mt-2">
    <div class="col-11 font-weight-bold ">
        UITRCE Dighalia, Khulna
    </div>
